...
final class Rbac
{
    ...
    public const PERMISSIONS = [
        ...
        'admin' => [
            ...
            'master-products.view',   'master-products.manage',
            'master-materials.view',  'master-materials.manage',
            'master-molds.view',      'master-molds.manage',
            'master-customers.view',  'master-customers.manage',
            'master-suppliers.view',  'master-suppliers.manage',
            'master-warehouses.view', 'master-warehouses.manage',
            'master-shifts.view',     'master-shifts.manage',
            'master-qc.view',         'master-qc.manage',
            'master-workcenters.view','master-workcenters.manage',
    ...
    private const PERMISSION_MAP = [
        ...
        'master-products.view'    => ['master_products',   ['can_view']],
        'master-products.manage'  => ['master_products',   ['can_create', 'can_update', 'can_delete']],
        'master-materials.view'   => ['master_materials',  ['can_view']],
        'master-materials.manage' => ['master_materials',  ['can_create', 'can_update', 'can_delete']],
        'master-molds.view'       => ['master_molds',      ['can_view']],
        'master-molds.manage'     => ['master_molds',      ['can_create', 'can_update', 'can_delete']],
        'master-customers.view'   => ['master_customers',  ['can_view']],
        'master-customers.manage' => ['master_customers',  ['can_create', 'can_update', 'can_delete']],
        'master-suppliers.view'   => ['master_suppliers',  ['can_view']],
        'master-suppliers.manage' => ['master_suppliers',  ['can_create', 'can_update', 'can_delete']],
        'master-warehouses.view'  => ['master_warehouses', ['can_view']],
        'master-warehouses.manage'=> ['master_warehouses', ['can_create', 'can_update', 'can_delete']],
        'master-shifts.view'      => ['master_shifts',     ['can_view']],
        'master-shifts.manage'    => ['master_shifts',     ['can_create', 'can_update', 'can_delete']],
        'master-qc.view'          => ['master_qc',         ['can_view']],
        'master-qc.manage'        => ['master_qc',         ['can_create', 'can_update', 'can_delete']],
        'master-workcenters.view' => ['master_workcenters',['can_view']],
        'master-workcenters.manage'=>['master_workcenters',['can_create', 'can_update', 'can_delete']],
