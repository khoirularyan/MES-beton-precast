...
class SalesOrderController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        $validated = $request->validate([
            ...
            'customer_id'           => 'required_if:so_type,MTO|nullable|exists:production_customers,id',
            ...
            'items.*.qty_reserved'  => 'nullable|numeric|min:0',
            'items.*.qty_to_produce'=> 'nullable|numeric|min:0',
